...
protected:
  ...
  // Optional override: wrap the per-item sequential stream (e.g. decryption) for Extract / GetStream.
  virtual HRESULT CreateItemInStream(UInt32 index, UInt64 pos, UInt64 size, ISequentialInStream **stream);
